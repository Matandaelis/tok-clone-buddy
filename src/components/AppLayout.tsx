  ...
  return (
    <header className="sticky top-0 z-40 h-14 bg-background/85 backdrop-blur-xl border-b border-border/60 flex items-center justify-between px-4 lg:px-6">
      <div className="flex items-center gap-2">
        ...
        <Link to="/" className="lg:hidden font-black text-lg text-foreground">
          TokShop
        </Link>
      </div>
      <div className="flex items-center gap-3">
        {user ? (
          ...
          <>
            ...
            <Link
              to="/signup"
              className="text-sm font-bold bg-primary text-primary-foreground px-4 py-1.5 rounded-full hover:bg-primary/90 transition-colors"
            >
              Sign up
            </Link>
          </>
